 ...
 */
#define HOST_IP_ADDR           0xC0A80899               // IP address of server to connect to
 ...
 */
#define CONFIG_IP       SL_IPV4_VAL(192,168,8,153)       /* Static IP to be configured */
#define AP_MASK         SL_IPV4_VAL(255,255,255,0)      /* Subnet Mask for the station */
#define AP_GATEWAY      SL_IPV4_VAL(192,168,8,1)        /* Default Gateway address */
